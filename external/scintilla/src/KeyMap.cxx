...
const KeyToCommand KeyMap::MapDefault[] = {
    ...
    // Extra defines for keypad
    { 0x100,			SCI_NORM,	SCI_EDITTOGGLEOVERTYPE},
    { 0x101,			SCI_NORM,	SCI_LINEEND},
    { 0x101,			SCI_SHIFT,	SCI_LINEENDEXTEND},
    { 0x102,			SCI_NORM,	SCI_LINEDOWN},
    { 0x102,			SCI_SHIFT,	SCI_LINEDOWNEXTEND},
    { 0x103,			SCI_NORM,	SCI_PAGEDOWN},
    { 0x103,			SCI_SHIFT,	SCI_PAGEDOWNEXTEND},
    { 0x104,			SCI_NORM,	SCI_CHARLEFT},
    { 0x104,			SCI_SHIFT,	SCI_CHARLEFTEXTEND},
    { 0x106,			SCI_NORM,	SCI_CHARRIGHT},
    { 0x106,			SCI_SHIFT,	SCI_CHARRIGHTEXTEND},
    { 0x107,			SCI_NORM,	SCI_HOME},
    { 0x107,			SCI_SHIFT,	SCI_HOMEEXTEND},
    { 0x108,			SCI_NORM,	SCI_LINEUP},
    { 0x108,			SCI_SHIFT,	SCI_LINEUPEXTEND},
    { 0x109,			SCI_NORM,	SCI_PAGEUP},
    { 0x109,			SCI_SHIFT,	SCI_PAGEUPEXTEND},
	{ 0x10a,			SCI_NORM,	SCI_CLEAR},
